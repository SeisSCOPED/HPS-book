...
7. **Network Settings**: ``Allow SSH traffic from `` -> ``My IP``.
    * **Select existing security group**, use `default`. This allows traffics in and out of the instance and is required for SSH (port 22) and Jupyter lab connection (port 8888).
